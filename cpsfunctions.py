#List of functions and classes for the fintech program
#1. registration function
#2. open skill database window function 
#3. open privacy statement window function
#4. check age function
#5. account login function
#6. unit currency function
#7. central bank class
